...
public class AuthorityFilter implements Filter {
	 ...
	 private static final Log logger = LogFactory.getLog(AuthorityFilter.class);
	    ...
	    private static final String LOGIN_URI = "/loginb";
		...
		public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		   ...
		   // 得到web应用程序的上下文路径
	    	...
	    	// 得到用户请求的URI
	    	  ...
	    	  StringBuffer ruquest_url= httpRequest.getRequestURL();
		    try
	        {
		    	  // 去除上下文路径，得到剩余部分的路径
		    	  ...
		    	  if (authority.getIsPass()==true) {
		    	   ...
		    	   if (pass)
		    	   {
		    	    chain.doFilter(request, response);
		    		   ...
		    		   String html="<script language=\"javascript\">window.location.href=\""+ctxPath+LOGIN_URI+"?returnurl="+AuthorityUtil.encodeUri(ruquest_url.toString())+"\"</script>";
