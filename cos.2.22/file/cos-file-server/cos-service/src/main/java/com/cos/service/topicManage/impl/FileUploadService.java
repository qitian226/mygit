...
/*
	...
	public String uploadTopicPic(SysAccount user,Long topicId, String imagedata, Integer width, Integer height, String imgType) throws Exception {
		...
		return topicEditService.updateTopicCover(topicId,url,width,height);
	}
	...
	@Override
	public String uploadIndexFile(byte[] bytes, String fileDir, String fileName, String imgType,Long accountId) throws Exception {
		 String imgurl=FileLocalUtils.uploadFiles(bytes,fileDir,fileName,imgType);
		 ImgFile ifile=new ImgFile();
         ifile.setId(Long.parseLong(fileName));
         ifile.setCreateBy(accountId);
