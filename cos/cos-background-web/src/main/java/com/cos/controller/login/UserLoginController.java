...
public class UserLoginController extends BaseController {
	...
	public String toLoginBrowser(HttpServletRequest request,String returnurl) throws Exception {
		return "login/login_b";
	}
	...
	public String loginMem(HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		if(StringUtils.isBlank(password)){
		 ...
		 if(!account.getType().equals("e")){
			 return ReturnJSONUtil.getWarnInfo("帐号没有权限!");
		}
		  try {
	...
	public String regAccount(HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String result=regAccountService.regAccount(reguser.toLowerCase(),password,mobile,nickname.toLowerCase(),"e");
        return result;
	}
